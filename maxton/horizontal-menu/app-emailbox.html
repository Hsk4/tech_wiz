  ...
  <main class="main-wrapper">
    ...
    <div class="email-wrapper">
      ...
      <div class="email-content">
        <div class="">
          <div class="email-list">
            ...
            <a href="app-emailread.html">
              <div class="d-md-flex align-items-center email-message px-3 py-1 mail-read">
                <div class="d-flex align-items-center email-actions">
                  <input class="form-check-input" type="checkbox" value=""> <i class='bx bx-star font-20 mx-2 email-star'></i>
      ...
      <div class="compose-mail-popup">
        <div class="card">
          <div class="card-header bg-grd-primary text-white py-2 cursor-pointer">
            <div class="d-flex align-items-center">
            ...
            <div class="email-form">
              ...
              <div class="mb-0">
                <div class="d-flex align-items-center">
                  <div class="">
                    <div class="btn-group">
                      <button type="button" class="btn btn-grd btn-grd-primary">Action</button>
                      <button type="button" class="btn btn-grd btn-grd-primary split-bg-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown">	<span class="visually-hidden">Toggle Dropdown</span>
                      </button>
