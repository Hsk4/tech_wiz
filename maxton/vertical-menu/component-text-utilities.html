  ...
  <main class="main-wrapper">
    <div class="main-content">
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
        <div class="col">
          <div class="card bg-primary text-center bg-none">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-secondary text-center bg-none">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-success text-center bg-none">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-danger text-center bg-none">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-warning text-center bg-none">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-info text-center bg-none">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-light text-center bg-none">
            <div class="card-body">
              <div class="p-4 text-white rounded">.bg-light</div>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card bg-dark text-center bg-none">
            <div class="card-body">
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
        <div class="col">
          <div class="card bg-grd-primary bg-gradient text-center">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-grd-voilet bg-gradient text-center">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-grd-success bg-gradient text-center">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-grd-danger bg-gradient text-center">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card bg-grd-warning bg-gradient text-center">
            <div class="card-body">
              <div class="p-3 text-white rounded">.bg-warning.bg-gradient</div>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card bg-grd-info bg-gradient text-center">
            <div class="card-body">
              <div class="p-3 text-white rounded">.bg-info.bg-gradient</div>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card bg-grd-branding text-center">
            <div class="card-body">
              <div class="p-3 text-white rounded">.bg-light.bg-gradient</div>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card bg-grd-deep-blue text-center">
            <div class="card-body">
