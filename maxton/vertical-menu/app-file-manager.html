            ...
            <div class="row mt-3">
              ...
              <div class="col-12 col-lg-4">
                <div class="card shadow-none border rounded-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="fm-icon-box rounded-4 bg-grd-deep-blue text-white"><i class='bx bxl-dropbox'></i>
                      </div>
                      <a href="javascript:;" class="primaery-menu-close">
                        <i class="material-icons-outlined">more_horiz</i>
                      </a>
                    ...
                    <div class="progress" style="height: 7px;">
                      <div class="progress-bar bg-danger bg-grd-deep-blue" role="progressbar" style="width: 45%;" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-lg-4">
                <div class="card shadow-none border rounded-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="fm-icon-box bg-grd-danger text-white rounded-4"><i class='bx bxs-door-open'></i>
                      </div>
                      <a href="javascript:;" class="primaery-menu-close">
                        <i class="material-icons-outlined">more_horiz</i>
                      </a>
                    ...
                    <div class="progress" style="height: 7px;">
                      <div class="progress-bar bg-grd-danger" role="progressbar" style="width: 65%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </div>
              </div>
